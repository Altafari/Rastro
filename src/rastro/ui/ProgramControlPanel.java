...
public class ProgramControlPanel extends BorderedTitledPanel implements IStateListener {
	...
	public ProgramControlPanel(SystemManager sysManager) {
		...
		radLabels.put(RAD_VALUES.length / 2,
				new JLabel(String.valueOf((int) (1000 * RAD_VALUES[RAD_VALUES.length / 2]))));
		radLabels.put(RAD_VALUES.length - 1,
				new JLabel(String.valueOf((int) (1000 * RAD_VALUES[RAD_VALUES.length - 1]))));
